...
export default function AIChatModal({ isOpen, onClose, selectedFloat }: AIChatModalProps) {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: '👋 Hi! I am **Astra Ocean AI** (powered by GPT-6 Astra). Ask me anything about ocean temperature profiles, thermocline behavior, salinity, or Indian Ocean dynamics!'
    }
  ])
  ...
  const handleSend = async () => {
    ...
    // Construct context string if a float is currently selected
    let contextStr = 'Platform: INCOIS Ocean Digital Twin (SIH 2026)'
    if (selectedFloat) {
    ...
    <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '11px', color: '#94a3b8' }}>
              INCOIS Ocean Assistant • Experiential Gateway
            </div>
          </div>
        </div>
        <button
      ...
      <div style={{
        ...
        <input
          ...
          placeholder="Ask GPT-6 Astra about ocean data..."
          disabled={loading}
          style={{
            flex: 1,
